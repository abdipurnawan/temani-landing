...
const LandingNavbar = () => {
  ...
  const variants = {
    ...
    floating: {
      ...
      maxWidth: "80rem", // max-w-5xl equivalent
  ...
  return (
    <>
      <div
        className={`fixed left-0 right-0 top-0  bg-white shadow-sm py-3 rounded-b-xl z-20 block lg:hidden`}
      >
        <div className="px-10">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 hidden lg:block container">
        <motion.div
          initial="normal"
          animate={controls}
          variants={variants}
        ...
        >
          <div>
            <div
              className={cn([
                "flex justify-between items-center py-3 transition-all duration-500",
                isFloating && "py-1",
              ])}
            >
              <motion.div>
